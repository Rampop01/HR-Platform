      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 py-16 bg-white">
        <div className="max-w-sm mx-auto w-full">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm">Sign in to manage your organization</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  className="w-full !pl-11 pr-3 h-11 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
